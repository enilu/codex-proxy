export const translations = {
  en: {
    ...
    weeklyLimitsTotalAccounts: "Accounts",
    weeklyLimitsAccountsWithLimits: "With weekly limits",
    weeklyLimitsLimitRows: "Weekly limit rows",
    weeklyLimitsAffectedAccounts: "Affected accounts",
    weeklyLimitsMissingQuota: "No quota data",
    weeklyLimitsSearch: "Search account, plan, status, or limit...",
    weeklyLimitsAccount: "Account",
    weeklyLimitsLimit: "Limit",
    weeklyLimitsState: "State",
    weeklyLimitsUsed: "Used",
    weeklyLimitsRemaining: "Remaining",
    weeklyLimitsReset: "Reset",
    weeklyLimitsActions: "Actions",
    weeklyLimitsExhausted: "Exhausted",
    weeklyLimitsAvailable: "Available",
    weeklyLimitsUnknown: "Unknown",
    weeklyLimitsNoData: "No weekly limit data yet. Refresh quota on an active account to populate it.",
    weeklyLimitsRefreshSuccess: "Quota refreshed",
    logs: "Logs",
    errorsTab: "Errors",
    ...
    generalSettingsProxyEnabled: "Enable Proxy",
    generalSettingsProxyEnabledHint: "Auto-detect local proxy and read HTTPS_PROXY env var. If off, goes direct unless proxy URL is explicitly set below.",
  ...
  zh: {
    ...
    usageStats: "用量统计",
    weeklyLimits: "周额度",
    weeklyLimitsTotalAccounts: "账号数",
    weeklyLimitsAccountsWithLimits: "有周限制",
    weeklyLimitsLimitRows: "周限制项",
    weeklyLimitsAffectedAccounts: "受影响账号",
    weeklyLimitsMissingQuota: "无配额数据",
    weeklyLimitsSearch: "搜索账号、计划、状态或限制...",
    weeklyLimitsAccount: "账号",
    weeklyLimitsLimit: "限制",
    weeklyLimitsState: "状态",
    weeklyLimitsUsed: "已用",
    weeklyLimitsRemaining: "剩余",
    weeklyLimitsReset: "重置",
    weeklyLimitsActions: "操作",
    weeklyLimitsExhausted: "已用完",
    weeklyLimitsAvailable: "可用",
    weeklyLimitsUnknown: "未知",
    weeklyLimitsNoData: "暂无周限制数据。请刷新一个活跃账号的配额后查看。",
    weeklyLimitsRefreshSuccess: "配额已刷新",
    logs: "日志",
    errorsTab: "错误",
    ...
    generalSettingsProxyEnabled: "启用代理",
    generalSettingsProxyEnabledHint: "自动探测本地代理并读取 HTTPS_PROXY 环境变量。关闭后直连，除非下方显式填写代理地址。",
